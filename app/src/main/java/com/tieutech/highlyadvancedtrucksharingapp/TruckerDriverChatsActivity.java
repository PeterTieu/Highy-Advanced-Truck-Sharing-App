...
public class TruckerDriverChatsActivity extends AppCompatActivity {
    ...
    private String username = "truck driver";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chats = new ArrayList<>();
        chatRecyclerViewAdapter = new ChatRecyclerViewAdapter(this, chats);
//        progressBar = findViewById(R.id.progressBar);
        ...
        chatListRecyclerView.setAdapter(chatRecyclerViewAdapter);
